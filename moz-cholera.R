...
if(tool_name != "_template") {
  source(here(paste0("01-", tool_name, "-required.R")))
  source(here(paste0("02-", tool_name, "-functions.R")))
  source(here(paste0("03-", tool_name, "-config.R")))
  source(here(paste0("04-", tool_name, "-dataload.R")))
  source(here(paste0("05-", tool_name, "-process.R")))
  #source(here(paste0("06-", tool_name, "-analysis.R")))
  source(here(paste0("07-", tool_name, "-plot.R")))
  #source(here(paste0("08-", tool_name, "-output.R")))
}
